 ...
 * route planner is always coupled to one {@link Vehicle}, the route planner
 * plans its routes for this vehicle instance.
 * <p>
...
public interface RoutePlanner {
  ...
  /**
   * Initializes the route planner for one specific {@link Vehicle} in a
   ...
   * @param dv The {@link Vehicle} for which routes will be planned.
   */
  void init(RoadModel rm, PDPModel pm, Vehicle dv);
   ...
   * <i>after</i> {@link #init(RoadModel, PDPModel, Vehicle)} and should be
   ...
   * first {@link Parcel} of the list must always be {@link #current()}.
   ...
   *         parcels to visit.
   */
  Optional<Parcel> next(long time);
